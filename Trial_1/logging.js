...
function reviewAnswers(taskNum) {
    ...
    if (taskNum == 2) {
        ...
        if (bool && bool2 && bool3 && bool4) {
            ...
            sendNetworkLog(uid, timeTaken, totalClicks, attempts, correctness, taskCode, score,'');
            alert("You have successfully cleared this task! Please proceed to the next Task.");
            window.location.href = "task3pre.html?score=" + score + "&task=1C" + "&id=" + uid;
            return;
        }
    }
    if (taskNum == 3) {
...
function goToTask1() {
    window.location.href = "index.html?score=" + score + "&task=1A" + "&id=" + uid;
}

function goToTask2() {
    window.location.href = "index2.html?score=" + score + "&task=1B" + "&id=" + uid;
}

function goToTask3() {
    window.location.href = "index3.html?score=" + score + "&task=1C" + "&id=" + uid;
}