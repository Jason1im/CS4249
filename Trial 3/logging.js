...
function goToTask1() {
    window.location.href = "index.html?score=" + score + "&task=3A" + "&id=" + uid;
}

function goToTask2() {
    window.location.href = "index2.html?score=" + score + "&task=3B" + "&id=" + uid;
}

function goToTask3() {
    window.location.href = "index3.html?score=" + score + "&task=3C" + "&id=" + uid;
}